  ...
  return (
    <section className="py-16 px-6" style={{ background: "#F0EEF8" }}>
      <div className="max-w-2xl mx-auto text-center">
        <p className="text-[10px] tracking-widest uppercase text-gray-500 mb-3">Confían en nosotros</p>
        ...
        <div className="relative flex items-center justify-center gap-3 sm:gap-4">
          ...
          <div
            key={s.id}
            className="flex-1 rounded-2xl flex flex-col items-center justify-center gap-4 py-8 px-6 sm:py-10 sm:px-8 transition-all duration-500"
            style={{
              background: "#fff",
          ...
          >
            <div
              className="w-16 h-16 sm:w-20 sm:h-20 rounded-xl flex items-center justify-center text-3xl"
